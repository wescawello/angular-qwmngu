...
import { faTrashAlt, faSquare, faCheckSquare, faCamera, faEye, faEnvelopeOpenText,faUserEdit,faHandPeace } from '@fortawesome/free-solid-svg-icons';
...
export class AppModule {
  constructor() {
    // Add an icon to the library for convenient access in other components
      library.add(faCamera, faTrashAlt, faEye, faEnvelopeOpenText, faUserEdit, faHandPeace);
